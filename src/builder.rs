...
//! The builder pattern is supported by the [`BuilderChain`](./builderchain) trait, which is implemented on the `Builder` struct, and also the common result type `BuilderResult`.
